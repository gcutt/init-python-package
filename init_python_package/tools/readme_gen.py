...
README_TEMPLATE = """# {pkgname}

This project was scaffolded using [init-python-package](https://pypi.org/project/init-python-package).

It provides a minimal Python package structure with a simple entrypoint (`main.py`) and ready-to-use
directories for source code, tests, data, and scripts. The intent is to give you a clean, reproducible
starting point for building your own Python projects.
